...
const ProductAppleAndPhone = () => {
  return (
    <>
      <div className="container">
        <Head>
          <title>Product/Apple-and-Phone - Innovation Store</title>
          <meta
            name="description"
          ...
          <meta
            property="og:title"
            content="Product/Apple-and-Phone - Innovation Store"
          />
          <meta
        ...
        <div className="top-container">
          ...
          <div className="hero">
            <img src="/playground_assets/apple-1000w.png" className="image" />
...
export default ProductAppleAndPhone
