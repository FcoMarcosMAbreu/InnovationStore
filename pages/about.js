        ...
        <div className="top-container">
          ...
          <div className="hero">
            <div className="content-container">
              <h1 className="heading text07">About</h1>
              <h2 className="subheading">Thank you for your interest!</h2>
              <span className="text08">
                <span>
                  This website is a side project to demonstrate my skills with
                  ReactJS, NextJS,
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                ...
                <span>
                  PostgreSQL at Supabase and deploy with GitHub and Cloudflare
                  Pages. Feel free to contact me.
                </span>
              </span>
              <a
          ...
          <div className="menu">
            ...
            <div className="links-container2">
              <div className="container1">
                <span className="text11">About us</span>
                <span className="text12">FAQ</span>
                <span className="text13">Terms and conditions</span>
                <a
                  href="https://github.com/FcoMarcosMAbreu"
                  target="_blank"
                  rel="noreferrer noopener"
